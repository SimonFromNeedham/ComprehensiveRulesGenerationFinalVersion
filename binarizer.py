"""This file helps us binarize numerical and categorical variables"""
...
# share_to_drop - max % of zeros allowed for a binarized column OR joint % of ones for the the most unballanced
# columns (with the least number of ones) which are joined together into 'other' category.
...
def drop_unbalanced(one_hot, column_name, numerical_binarization, share_to_drop):
    ...
    # d rop columns which have too many ones
    for col in one_hot.columns:
